...
const Cases = () => {
  ...
  const imageList = [
    ...
    { image: neon, style: styles.item3, link: '/animation', category: 'Animation' },
    { image: car, style: styles.item4, link: '/webdevelopment', category: 'Web Development' },
    ...
    { image: calendar, style: styles.item13, link: '/logos', category: 'Logos' },
    ...
    { image: art_design, style: styles.item13, link: '/logos', category: 'Logos' },
  ];
